...
public class HelpActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    public void onBackPressed() {
        ...
        imm.hideSoftInputFromWindow(findViewById(R.id.help_layout_explorer).getWindowToken(), 0);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.btn_send_help:
                ...
                String helpText = etHelp.getText().toString().trim();
    ...
    private void showConfirmationDialog() {
        ...
        btnYes.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                AppUtils.showToastBlack(HelpActivity.this, "Your request has been sent");
                Intent intent = new Intent(HelpActivity.this, ExplorerHomeActivity.class);

...
public class MonthAndYearPicker {
     ...
     *            the activity
     */
    public MonthAndYearPicker(Activity activity) {
        this.activity = activity;
        this.view = activity.getLayoutInflater().inflate(R.layout.layout_month_year_picker, null);
    }
    ...
    public void build(int selectedMonth, int selectedYear, DialogInterface.OnClickListener positiveButtonListener,
        ...
        builder.setTitle(activity.getResources().getString(R.string.alert_dialog_title));
        builder.setPositiveButton(activity.getResources().getString(R.string.positive_button_text), positiveButtonListener);
        builder.setNegativeButton(activity.getResources().getString(R.string.negative_button_text), negativeButtonListener);
        build = true;

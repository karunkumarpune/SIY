...
public class SwipeToDeleteHelper extends ItemTouchHelper.SimpleCallback {
    ...
    SwipeToDeleteHelperListener listener;


    public SwipeToDeleteHelper(int dragDirs, int swipeDirs, SwipeToDeleteHelperListener listener) {
    ...
    public interface SwipeToDeleteHelperListener{
